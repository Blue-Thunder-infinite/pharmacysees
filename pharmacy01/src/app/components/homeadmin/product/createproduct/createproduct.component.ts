...
getCategories() {
  ...
  this.categoriesService.getCategoryList().pipe(
    ...
    next: (response) => {
      ...
      this.itemsCategories = this.categories.Categories; 
...
onproduct() {
 ...
 if (this.newProductForm.invalid) {
  ...
  this.productService.createproduct(postData).pipe(
    ...
    next: (response) => {
        ...
        this.newproduct = this.dataproduct.NewProduct;

        //alert("Estoy en product.component - line 104 - this.         mensajeBackend:  "+this.mensajeBackend);
        //alert("Estoy en product.component - line 105 - this.newproduct:  " +this.newproduct);
 ...
 if (this.newproduct) {
      this.toast.success('Create product component - line 114 - Create product successfully');
