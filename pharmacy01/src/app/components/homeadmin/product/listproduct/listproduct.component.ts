  ...
  getDataProducts() {
    ...
    this.ProductsService.getproductsList().pipe(
      ...
      next: (response) => {
       ...
       alert("Estoy en listCategorys-component - line 81 - this.DataCategory.Categories.name="+ this.DataProduct.products[0].name);
...
get filteredProducts(): Product[] {
  return this.items?.products?.filter((item:any) => 
