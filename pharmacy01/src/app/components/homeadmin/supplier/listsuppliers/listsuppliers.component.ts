...
/***** End of vars to handle pagination  */
  ...
  getDataSuppliers() {
    ...
    //alert("Estoy en listSuppliers-component - line 68 - getDataSuppliers");
    ...
    this. suppliersService.getsuppliersList().pipe(
      ...
      next: (response) => {
       ...
       /**alert("Estoy en listSuppliers-component - line 83 - this.DataSupplier.Suppliers.name="+ this.DataSupplier.Suppliers[0].name);*/
...
deleteDetails (Data:any,index:any,event:any) {
  ...
  this.suppliersService.deletesupplier(Data._id).subscribe((data) => {
...
get filteredSuppliers(): Suppliers[] {
  return this.items?.Suppliers?.filter((item:any) => 
