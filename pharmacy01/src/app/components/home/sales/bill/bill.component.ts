...
// getting the elements names and amount to save in database sales 
  ...
  /************************ End of cart part *******************/
   ...
   const postData: any = { ...this.salesForm.value };
    ...
    const name  = this.salesForm?.value.name; // Client Name
    const client_CI = this.salesForm?.value.client_CI; // Client CI
    const phone = this.salesForm?.value.phone; // Client phone
  ...
  /*alert ("Im in bill.component - line 169 - Seller_name: "+ seller_name);
    ...
    alert ("Im in bill.component - line 178 - elementNames: "+ elementNames);*/
    
    
    this.saleService.createsale(name, client_CI, phone ,seller_name, amount_sold, quantity_sold,elementNames ).pipe(
      ...
      next: (response) => {
        ...
        //alert("Estoy en bill.component - line 184 - this.         mensajeBackend:  "+this.mensajeBackend);
    
        // alert("Estoy en bill.component - line 186 - this.newsale:  " +this.newsale);
   ...
   if (this.newsale) {
        this.toast.success('Create supply component - line 194 -Create Bill successfully');
